	...
	<div class="report-container">
                <div class="report-content">
                        <div class="report-header">
                                ...
                                <h3 class="report-name">Penjualan Menu dan Pendapatan Tahunan</h3>
                        </div>
                        ...
                        <table>
                                ...
                                <tbody>
                                        @for ($i = 0; $i < count($pendapatan); $i++)
                                                ...
                                                @if ($penjualan[$j]->Bulan === $pendapatan[$i]->Bulan)
                                                <tr>
                                                        <td>{{ $pendapatan[$i]->Bulan }}</td>
                                                        <td>{{ $penjualan[$j]->nama_menu }}</td>
                                                        <td>{{ $penjualan[$j]->Jumlah }}</td>
                                                        <td>{{ $penjualan[$j]->harga_menu }}/pcs</td>
                                                </tr>
                                                @endif
                                                @endfor
                                        @endfor
